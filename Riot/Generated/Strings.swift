...
public class VectorL10n: NSObject {
  ...
  /// Open Superhero Chat on your other device
  ...
  /// You need to verify this session in order to read your secure message history.\n\nOpen Superhero Chat on one of your other devices and follow the instructions.
  ...
  /// If you’d like to share your Live location, Superhero Chat needs location access when the app is in the background.\nTo enable access, tap Settings> Location and select Always
  ...
  /// Superhero Chat is also great for the workplace. It’s trusted by the world’s most secure organisations.
  ...
  /// Superhero Chat is a new type of messenger and collaboration app that:\n\n1. Puts you in control to preserve your privacy\n2. Lets you communicate with anyone in the Matrix network, and even beyond by integrating with apps such as Slack\n3. Protects you from advertising, datamining, backdoors and walled gardens\n4. Secures you through end-to-end encryption, with cross-signing to verify others\n\nSuperhero Chat is completely different from other messaging and collaboration apps because it is decentralised and open source.\n\nSuperhero Chat lets you self-host - or choose a host - so that you have privacy, ownership and control of your data and conversations. It gives you access to an open network; so you’re not just stuck speaking to other Superhero Chat users only. And it is very secure.\n\nSuperhero Chat is able to do all this because it operates on Matrix - the standard for open, decentralised communication. \n\nSuperhero Chat puts you in control by letting you choose who hosts your conversations. From the Superhero Chat app, you can choose to host in different ways:\n\n1. Get a free account on the matrix.org public server\n2. Self-host your account by running a server on your own hardware\n3. Sign up for an account on a custom server by simply subscribing to the Superhero Chat Matrix Services hosting platform\n\nWhy choose Superhero Chat?\n\nOWN YOUR DATA: You decide where to keep your data and messages. You own it and control it, not some MEGACORP that mines your data or gives access to third parties.\n\nOPEN MESSAGING AND COLLABORATION: You can chat with anyone else in the Matrix network, whether they’re using Superhero Chat or another Matrix app, and even if they are using a different messaging system of the likes of Slack, IRC or XMPP.\n\nSUPER-SECURE: Real end-to-end encryption (only those in the conversation can decrypt messages), and cross-signing to verify the devices of conversation participants.\n\nCOMPLETE COMMUNICATION: Messaging, voice and video calls, file sharing, screen sharing and a whole bunch of integrations, bots and widgets. Build rooms, communities, stay in touch and get things done.\n\nEVERYWHERE YOU ARE: Stay in touch wherever you are with fully synchronised message history across all your devices and on the web at https://element.io/app.
  ...
  /// Verified sessions are anywhere you are using Superhero Chat after entering your passphrase or confirming your identity with another verified session.\n\nThis means that you have all the keys needed to unlock your encrypted messages and confirm to other users that you trust this session.
