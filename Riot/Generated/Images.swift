...
internal class Asset: NSObject {
  ...
  @objc(AssetImages) internal class Images: NSObject {
    ...
    internal static let communityRoomIcon = ImageAsset(name: "community_room_icon")
    ...
    internal static let superheroLogoDark = ImageAsset(name: "superheroLogoDark")
    internal static let superheroLogoLight = ImageAsset(name: "superheroLogoLight")
    internal static let tokenGatedRoomIcon = ImageAsset(name: "token_gated_room_icon")
    ...
    internal static let loading4 = ImageAsset(name: "loading4")
